...
#else
#define aw_dev_err(dev, format, ...) no_printk(format , dev, ##__VA_ARGS__)
#define aw_dev_info(dev, format, ...) no_printk(format , dev, ##__VA_ARGS__)
#define aw_dev_dbg(dev, format, ...) no_printk(format , dev, ##__VA_ARGS__)
