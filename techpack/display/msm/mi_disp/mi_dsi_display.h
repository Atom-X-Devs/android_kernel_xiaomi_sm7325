...
struct dsi_display *mi_get_dsi_display(int type);
...
ssize_t mi_dsi_display_show_dsi_cmd_set_type(void *display, char *buf, size_t size);
...
int mi_dsi_display_get_max_brightness_clone(void *display, u32 *max_brightness_clone);
...
ssize_t mi_dsi_display_cell_id_read(void *display, char *buf, size_t size);
