...
static struct qcom_icc_qosbox xm_pcie3_3_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x8000 },
	.config = &(struct qos_config) {
...
static struct qcom_icc_node xm_pcie3_3 = {
	.name = "xm_pcie3_3",
	.id = MASTER_PCIE_3,
	.channels = 1,
	.buswidth = 16,
	.noc_ops = &qcom_qnoc4_ops,
	.qosbox = &xm_pcie3_3_qos,
	.num_links = 1,
	.links = { SLAVE_ANOC_PCIE_GEM_NOC },
};
...
static struct qcom_icc_qosbox xm_ufs_g4_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0xf000 },
	.config = &(struct qos_config) {
...
static struct qcom_icc_node xm_ufs_g4 = {
	.name = "xm_ufs_g4",
	.id = MASTER_UFS_GEN4,
	.channels = 1,
	.buswidth = 8,
	.noc_ops = &qcom_qnoc4_ops,
	.qosbox = &xm_ufs_g4_qos,
	.num_links = 1,
	.links = { SLAVE_A1NOC_SNOC },
};
...
static struct qcom_icc_qosbox qhm_qspi1_qos = {
	.regs = icc_qnoc_qos_regs[ICC_QNOC_QOSGEN_TYPE_RPMH],
	.num_ports = 1,
	.offsets = { 0x13000 },
	.config = &(struct qos_config) {
...
static struct qcom_icc_node qhm_qspi1 = {
	.name = "qhm_qspi1",
	.id = MASTER_QSPI_1,
	.channels = 1,
	.buswidth = 4,
	.noc_ops = &qcom_qnoc4_ops,
	.qosbox = &qhm_qspi1_qos,
	.num_links = 1,
	.links = { SLAVE_A2NOC_SNOC },
};
...
static struct qcom_icc_desc scshrike_aggre1_noc = {
...
static struct qcom_icc_desc scshrike_aggre2_noc = {
...
static struct qcom_icc_desc scshrike_camnoc_virt = {
...
static struct qcom_icc_desc scshrike_compute_noc = {
...
static struct qcom_icc_desc scshrike_config_noc = {
...
static struct qcom_icc_desc scshrike_dc_noc = {
	.nodes = dc_noc_nodes,
...
static struct qcom_icc_desc scshrike_gem_noc = {
	.nodes = gem_noc_nodes,
...
static struct qcom_icc_desc scshrike_ipa_virt = {
...
static struct qcom_icc_desc scshrike_mc_virt = {
	.nodes = mc_virt_nodes,
...
static struct qcom_icc_desc scshrike_mmss_noc = {
...
static struct qcom_icc_desc scshrike_system_noc = {
...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	dev_dbg(&pdev->dev, "Registered SCSHRIKE ICC\n");
...
static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,scshrike-aggre1_noc",
	  .data = &scshrike_aggre1_noc
	},
	{ .compatible = "qcom,scshrike-aggre2_noc",
	  .data = &scshrike_aggre2_noc
	},
	{ .compatible = "qcom,scshrike-camnoc_virt",
	  .data = &scshrike_camnoc_virt
	},
	{ .compatible = "qcom,scshrike-compute_noc",
	  .data = &scshrike_compute_noc
	},
	{ .compatible = "qcom,scshrike-config_noc",
	  .data = &scshrike_config_noc
	},
	{ .compatible = "qcom,scshrike-dc_noc",
	  .data = &scshrike_dc_noc
	},
	{ .compatible = "qcom,scshrike-gem_noc",
	  .data = &scshrike_gem_noc
	},
	{ .compatible = "qcom,scshrike-ipa_virt",
	  .data = &scshrike_ipa_virt
	},
	{ .compatible = "qcom,scshrike-mc_virt",
	  .data = &scshrike_mc_virt
	},
	{ .compatible = "qcom,scshrike-mmss_noc",
	  .data = &scshrike_mmss_noc
	},
	{ .compatible = "qcom,scshrike-system_noc",
	  .data = &scshrike_system_noc
	},
	{ }
};
