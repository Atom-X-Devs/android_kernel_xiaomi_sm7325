...
static inline int 
fscrypt_select_encryption_impl(struct fscrypt_info *ci, bool is_hw_wrapped_key)
{
	return 0;
}
...
static inline int
fscrypt_derive_raw_secret(struct super_block *sb, const u8 *wrapped_key,
					    unsigned int wrapped_key_size, u8 *raw_secret,
					    unsigned int raw_secret_size)
{
	fscrypt_warn(NULL,
